...
<body>
    <div class="container">
        ...
        <form action="<?php echo site_url('jadwal_kapal/edit_action'); ?>" method="post">
            ...
            <div class="form-wrapper">
                ...
                <div class="form-item asal">
                    ...
                    <input type="text" id="pelabuhan_asal" name="pelabuhan_asal" value="<?php echo $alur_kapal[0]->pelabuhan_asal ?>" required>
                </div>

                <div class="form-item tujuan">
                    <label for="pelabuhan_tujuan">Tujuan</label>
                    <input type="text" id="pelabuhan_tujuan" name="pelabuhan_tujuan" value="<?php echo $alur_kapal[0]->pelabuhan_tujuan ?>" required>
                </div>

                <div class="form-item">
                    <label for="waktu_masuk">Waktu Masuk</label>
                    <input type="datetime-local" id="waktu_masuk" name="waktu_masuk" value="<?php echo $alur_kapal[0]->waktu_masuk ?>" required>
                </div>

                <div class="form-item">
                    <label for="waktu_keluar">Waktu Keluar</label>
                    <input type="datetime-local" id="waktu_keluar" name="waktu_keluar" value="<?php echo $alur_kapal[0]->waktu_keluar ?>" required>
                </div>
        ...
        <div class="button-wrapper">
            ...
            <button type="submit" class="search-button">Simpan Jadwal</button>
        </div>
    </div>
